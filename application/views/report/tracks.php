                ...
                <div class="box">
                    ...
                    <div class="col-xs-12">
                      <form action="<?php echo base_url(); ?>reports/print_client_count" id="form1" method="post" target="_blank" >
                        ...
                        <div class="col-md-3">
                        <label>Date: </label> 
                        <input type="text" name="date" id="date_range" class="form-control daterange" placeholder="Start and End Date" />
                        </div>
                        <div class="col-md-2">
                        <label>Alert: </label> 
...
$.ajax({
  type: "POST",
  url: "<?php echo base_url().'reports/get_tracks'; ?>",
      ...
      table.clear();
       $.each(data.tracks, function(key, val){
        ...
        datetime = convert_datetime(val.datetime);
         var rowNode = table.row.add([ val.lname,
                      val.fname,
                      val.mname,
                      val.contact_number,
                      address,
    ...
    buttons:[
              ...
              },
              {
                ...
                title: function() {
                      ...
                      var date1 = convert_date(dates[0]);
                      var date2 = convert_date(dates[1]);
                      return `${$( "#est_id option:selected" ).text()} \nInclusive dates: ${date1} To ${date2}`
                    },
                text: 'PDF',
                exportOptions: {
                 columns: [ 0,1,5,6 ],
