                        ...
                        <label>First Dose Vaccination Site:</label>
                         <div class="form-group input-group smallmargin">
                            ...
                            <select id="first_vac_site" name="first_vac_site" class="form-control select2 required" required="required">
                              ...
                              <option value="1">Batong Malake Covered Court</option>
                              <option value="2">UPLB Copeland Gymnasium</option>
                              <option value="3">MGLB Evacuation Center</option>
                              <option value="4">St. Jude</option>
                              <option value="5">LBDH</option>
                              <option value="6">HealthServ</option>
                              <option value="7">UPLB - UHS</option>
                             </select>
                          </div>
                        </div>
                       <div class="form-group col-md-3 smallmargin">
                      ...
                      <div class="form-group col-md-4">
                        <label>Date of Vaccination</label>
                          <div class="form-group input-group">
                            ...
                            <input id="vac_date" name="vac_date" placeholder="Date of Vaccination" class="form-control datepicker_full" type="text"  required="required">
                          </div>
                      </div>
                       <div class="form-group col-md-4 smallmargin">
                      ...
                      <div class="form-group col-md-4">
                        <label>Batch Number</label>
                          <div class="form-group input-group">
                            ...
                            <input id="batch_number" name="batch_number" placeholder="Batch Number" class="form-control" type="text" >
                          </div>
                      </div>
                      <div class="form-group col-md-4">
                        <label>Lot Number</label>
                          <div class="form-group input-group">
                            ...
                            <input id="lot_number" name="lot_number" placeholder="Lot Number" class="form-control" type="text" >
                          </div>
                      </div>
                       <div class="form-group col-md-4 smallmargin">
                        <label>Name of Vaccinator</label>
                         <div class="form-group input-group smallmargin">
                            ...
                            <select id="vaccinator_name" name="vaccinator_name" class="form-control select2 required"  required="required">
                              ...
                              <option value="Maria Cristina Wagan-Zafalla, RN">Maria Cristina Wagan-Zafalla, RN</option>
                              <option value="DOCTOR CYNTHIA A. ESPERANZA, MD">DOCTOR CYNTHIA A. ESPERANZA, MD</option>
                              <option value="DOCTOR LYDIA B. ISIDORO, MD">DOCTOR LYDIA B. ISIDORO, MD</option>
                             </select>
                          </div>
                        </div>                        
                        <div class="form-group col-md-12 smallmargin">
                      ...
                      <div class="form-group col-md-4">
                        <label>Next Vaccination Date</label>
                          <div class="form-group input-group">
                            ...
                            <input id="next_vac_date" name="next_vac_date" placeholder="Next Vaccination Date" class="form-control datepicker_full" type="text"  required="required">
                          </div>
                      </div>
      ...
      success: function(data){
        if(data.error == 0){
          ...
          $.each( data.details, function( key, val ) {
            ...
            if(val.next_vac_date!='0000-00-00'){
              $('#next_vac_date').val(convert_date_full(val.next_vac_date));
            }
...
$(document).ready(function(){
  ...
  $('#vac_date').change(function(){
    ...
    $('#next_vac_date').val(convert_date_full(next_vac_date));
  });
  if(search_userid!==''){
