 ...
 -->                             </select>
                       ...
                       <div class="form-group input-group smallmargin ">
                        ...
                        <div class="form-group col-md-4">
                          <div class="form-group input-group">
                            ...
                            <input id="contact_number" name="contact_number" placeholder="Contact Number" class="form-control" required="required" type="number" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==12) return false;">
                          </div>
                        </div>
                        <div class="form-group col-md-4">
                          <div class="form-group input-group">
                       ...
                       <div class="form-group input-group smallmargin">
                        ...
                        <div class="form-group col-md-3">
                          <div class="form-group input-group">
                            ...
                            <input type="text" id="birthday" name="birthday" placeholder="Date of Birth" class="form-control datepicker"  required>
                          </div>
                        </div>
                        <div class="form-group col-md-3">
                          <div class="form-group input-group">
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-4 smallmargin">
                       ...
                       <div class="form-group col-md-4 smallmargin">
                        <label>Provide Electronic Consent?</label>
                         <div class="form-group input-group smallmargin">
                            <div class="input-group-prepend">
                                <span class="input-group-text"> <i class="fa fa-circle"></i> </span>
                             </div>
...
<script type="text/javascript">
  ...
  function get_details(qrcode,birthday){
    $.ajax({
      type: "POST",
      url: "<?php echo base_url(); ?>Vaccination/confirm_details",
      dataType: "JSON",
...
$("#vac_form").submit(function(e){
      e.preventDefault();
        ...
        success: function (data) { 
          ...
          var brgy = data.client_info.brgyDesc.toUpperCase();
            ...
            $('#resbakuna_date').html(`<b style="color:red">${data.client_info.date_reg}</b>`);
            ...
            toastr.warning('Duplicate Name or Client Already Registered!');
          }
          $('#vac_form').trigger("reset");
          $('#qrcode').val('');
          $('#userid').val('');
  ...
  function convert_datetime(date){
    ...
    hour     = from.getHours() < 10? '0'+from.getHours():from.getHours();
    min     = from.getMinutes() < 10? '0'+from.getMinutes():from.getMinutes();
    sec     = from.getSeconds() < 10? '0'+from.getSeconds():from.getSeconds();
    converted_date = monthNames[month] + ' ' + day + ', '+ yr + ' ' + hour + ":" + min + ":" + sec;
