...
<!---- MODAL DISABLE-->
<div class="modal fade" id="disable_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <!-- Modal Header -->
        ...
        <div class="modal-footer" align="right">
          <div class="form-group">
            <div class="col-sm-12" align="right">
              ...
              <button id="confirm_disable" class="btn btn-danger pull-right"><i class="fa fa-ban fa-lg"></i>&nbsp; Disable</button>
            </div>
          </div>
        </div>
      </div>
...
<!---- MODAL DISABLE-->
<div class="modal fade" id="enable_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <!-- Modal Header -->
      <div class="modal-header alert alert-danger">
      ...
      <!--Modal Body For Update -->
      <div class="modal-body table-responsive">
        <div id="enable_display">
        </div>
        <input type="hidden" name="eclient_id" id="eclient_id">
        <div class="modal-footer" align="right">
          <div class="form-group">
            <div class="col-sm-12" align="right">
              <button type="button" class="btn btn-default" data-dismiss="modal">
              ...
              <button id="confirm_enable" class="btn btn-info pull-right"><i class="fa fa-ban fa-lg"></i>&nbsp; Enable</button>
            </div>
          </div>
        </div>
      </div>
...
<!---- MODAL VIEW DOSES-->
<div class="modal fade" id="dose_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
<div class="modal fade" id="merge_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body table-responsive">
        <label>USERID:</label>
        <input type="text" class="form-control" name="merge_userid" id="merge_userid">
        <input type="hidden" name="post_vac_id" id="post_vac_id">
        <input type="hidden" name="merge_dose" id="merge_dose">
        <input type="hidden" name="current_userid" id="current_userid">
        <input type="hidden" name="vac_date" id="vac_date">
        <div class="modal-footer" align="right">
          <div class="form-group">
            <div class="col-sm-12" align="right">
              <button type="button" class="btn btn-default" data-dismiss="modal">
              ...
              <button id="confirm_merge" class="btn btn-info pull-right"><i class="fa fa-check fa-lg"></i>&nbsp; Merge</button>
            </div>
          </div>
        </div>
      </div>
