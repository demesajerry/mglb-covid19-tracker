...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url();?>Tagger/vaccination">
          <i class="fa fa-syringe"></i>
          <span>Vaccination</span></a>
      </li>
      <?php 
      if(!in_array($this->session->userdata('tagger_logged_in')->access,array(1,2)))
        ?>
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url();?>Vac_list/">
          <i class="fa fa-list"></i>
          <span>Vaccination List</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url();?>Vac_list/disabled_list">
          <i class="fa fa-list"></i>
          <span>Disabled client List</span></a>
      </li>
<!--       <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url();?>Tagger/scan">
 ...
 -->                
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= $userdata->fullname ?></span>
...
<script type="text/javascript">
 ...
 $('.daterange').on('apply.daterangepicker', function(ev, picker) {
  ...
  $('#confirm_logout').click(function(){
    window.location.href = "<?php echo base_url(); ?>Tagger/logout";
  });
