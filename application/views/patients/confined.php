        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <h3 class="box-title">Confirmed Cases Residing Outside of Los Baños Confined Within Municipality</h3>
                        <div class="box-tools">
                            <button class="btn btn-info" id="add_patients" >
                                <i  class="fa fa-plus fa-1x"> </i> Add Confined Case
                            </button>
                        </div>
                    </div>
                <hr />
